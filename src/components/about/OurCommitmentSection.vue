<template>
  <div class="w-full mb-8 space-y-1 mt-8 md:mt-[70px] px-4 md:px-0">
    <div>
      ...
      <div class="flex flex-col md:flex-row space-x-0 md:space-x-6 md:items-start md:relative mt-0 md:mt-4">
        <img v-lazy="require('@/assets/image-17.png')" ref="commitmentImage" alt="Header Image" class="hidden md:block w-full md:w-[777px] h-[181px] md:h-[518px] object-cover md:ml-[-50px] lg:ml-[-135px]">
        <div ref="commitmentText" class="space-y-10 px-4 md:px-0 mt-4 md:mt-0">
          <p class="font-nunito text-left w-full md:w-[637px] mt-6 md:mt-12 md:mt-24">
          ...
          <p class="font-nunito text-left w-full md:w-[637px]">
