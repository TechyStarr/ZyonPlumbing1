<template>
  <div class="w-full space-y-12 mt-[70px] mb-6">
    <div>
      ...
      <div class="flex flex-col md:flex-row space-x-0 md:space-x-6 md:items-start md:relative mt-4">
        <img src="@/assets/header-img.png" alt="Header Image" class="hidden md:block w-[777px] h-[518px] object-cover md:ml-[-200px]">
