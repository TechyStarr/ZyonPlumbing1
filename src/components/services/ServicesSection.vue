<template>
    <div>
      <div v-for="(section, index) in sections" :key="index" class="flex flex-col md:flex-row justify-between items-center mb-[70px] px-4 md:px-32">
        ...
        <div class="space-y-2 flex flex-col items-center md:items-start md:order-2 w-full md:w-auto">
          <img :src="section.icon" alt="Check square" class="mx-auto md:ml-32 h-8">
        ...
        <img :src="section.image" alt="Check square" class="w-full md:w-[423px] h-[265px] rounded md:order-3 mt-4 md:mt-0">
      </div>
